...
(function() {
  jQuery(function($) {
    var accordionCollection, dialogModel, selectCollection, tabsCollection;
    ...
    _.delay(function() {
      return dialogModel.set('title', '标题修改');
    }, 2000);
    new JT.View.Alert({
      model: dialogModel
    });
    ...
    _.delay(function() {
      return accordionCollection.add({
        title: '添加数据',
